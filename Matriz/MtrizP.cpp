...
int main()
{
    int matriz[100][100],filas,columnas,i,j,suma=0,promedio,mini,maxi=0,x,y,mayor,menor,tam=filas*columnas,e;
    ...
    for(i=0;i<filas;i++)/*realiza la suma de los elementos de mi matriz*/
    {
        for(j=0;j<columnas;j++)
        {
 ...
 /*#################################################################################################################*/
    for(i=0; i<filas; i++)/*ordena mi matriz*/
     {
        for(j=0; j<columnas; j++)
        {
            for(x=0; x<filas;x++)
